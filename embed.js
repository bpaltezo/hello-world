var sentences={bolinao:['Adti ka mako? ','Kae ko rabay en. ','Angkay magwa manepet? ','Kano ka magawid? ',"Omno'y pasahe anggan babali? "],tagalog:['Saan ka pupunta? ','Ayaw ko nyan. ','Kuya/Ate pwede magtanong?','Kailan ka uuwi? ','Magkano ang pamasahe hanggang bayan? '],english:['Where are you going? ',"I don't like that.",'Can i ask you a question? ','When will you come home? ','How much it cost to travel to town? '],prons:['Ad-ti ka ma-ko?','Ka-e ko ra-bay en','Ang-kay mag-wa ma-ne-pet?','Ka-no ka ma-ga-wid?',"Om-no'y pa-sa-he- ang-gan ba-ba-li?",],myReminder: ["Suppose you are traveling to Bolinao and finds it hard to communicate. Well, worry no more because here at BOLINAO INSIDER, we are giving you the most common bolinao dialogue that may help you to communicate upon your visit."],T_noDataFound: ['Sorry no data found.','Your word must be accurate with our database. Try searching the word at the top bar. Thanks','Your word is not a Bolinao term.'],noData: ['No data yet. We are doing our best to research all bolinao terms in relation with this letter.']};var links={myAddress:["https://bolinaoinsider.com"],affiliates:[]}var word_A={bolinao:["abante","abas","abaw","adal","adani","adti","agameren","agom","akay","alaki","amay","ambog","amot","anas","ane","andyak","apay","apid","arak","arek","aras","ari","aronsa","arkos","asi","atado","ator","awro"],tagalog:["abante","mali","madami","aral","malapit","saan","kagamitan","sakim","turo","malaki","tito","mayabang","init","bulong","ano","ayaw","banig","pinsan","alak","halik","pera","kapatid","kaunlaran","palamuti","swerte","hati/tumpok","nitabi/naitago","araw"],english:["forward","wrong","plenty","learning","near","where","properties","selfish","teaching","big","uncle","boastful","heat","whisper","what","don't want","mat","relative","wine/liquor","kiss","younger brother/sister","coins","progress","decoration","luck","slice/bunch of item for sale","something kept for emergency","day/sun"],form:["adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj","adj"],prons:["a-ban-te","a-bas","a-baw","a-dal","a-da-ni","ad-ti","a-ga-me-ren","a-gom","a-kay","a-la-ki","a-may","am-bog","a-mot","anas","ane","an-dyak","apay","a-pid","a-rak","a-rek","a-ras","-ari","aron-sa","ar-kos","a-si","ata-do","a-tor"]};var word_B={bolinao:["baaw", "babali", "badak", "badanan", "baile", "bakas", "bake", "balasang", "bale", "balitok", "balon", "balsa", "baluto", "banong", "bansal", "bari", "bayente", "bikoy", "bilang", "bisang", "bitil", "buklas", "bulan", "bulo", "bulong", "buro", "busat", "butal", "butlay"],tagalog:['kaning lamig','bayan','bayawak','dahilan','sayaw','hitsura','unggoy','dalaga','bahay','kayamanan','baon','balsa','baon','naghihirap/walang pera','kasal','bali','bente','buto/gulong','parang','punit','gutom','umaga','buwan','pilay','dahon','uod','kapatid','sobra','gitna'],english: ['rice','town','to be searched','reason','dance','looks','monkey','maiden','house','treasure/gold','pocket money','raft','boat','penniless','wedding','torn','twenty','seed/wheel','like/alike','tear','hungry','morning','moon/month','fracture','leaves','worm','brother/sister','excess','center'],form: ['adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.'],prons: ['ba-aw','ba-ba-li','ba-dak','ba-da-nan','bai-le','bakas','ba-ke','ba-la-sang','bale','ba-li-tok','ba-lon','bal-sa','ba-lu-to','ba-nong','ban-sal','ba-ri','ba-yen-te','bikoy','bilang','bi-sang','bi-til','buk-las','bu-lan','bulo-','bu-long','bu-ro','bu-sat','bu-tal','but-lay']};var word_D={bolinao:['dakap','dakep','dalan','dalian','dalit','damag','datong','daya','denep','dilap','dita','dite','duka','dukdok','duma','dumalan','dumrak','dumungdong'],tagalog:['gapang','huli','daan','bilisan','dikit','kasintahan','alay','dugo','ipon','bukas','lason','maliit','pangit','sayaw','iba','dumaan','makalat','yumuko'],english:['crawl','capture','way/road','faster','stick','girlfriend/boyfriend','offering','blood','savings/group','tomorrow','poison','little','ugly','dance','different','pass by','tobesearched','look'],form:['adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.'],prons:['da-kap','da-kep','da-lan','da-li-an','da-lit','da-mag','da-tong','da-ya','de-nep','di-lap','di-ta','di-te','du-ka','duk-dok','duma','du-ma-lan','dum-rak','du-mung-dong']};var word_E={bolinao:['eka','ekap','elew','erek','ergo','esen','esrep','etaker','eti','etiko','ewer-ewer'],tagalog:['ilagay','laro','nangungulila','palay','salita','diyan','ipasok','itali','dito','iliko','nahihilo'],english:['put','game','miss','rice grain','language','there','enter','tie','here','turn','dizzy'],form:['adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.'],prons:['eka','e-kap','e-lew','e-rek','er-go','e-sen','es-rep','eta-ker','eti','eti-ko','ewer-ewer']};var word_G={bolinao:['gamay','gamet','gana-gana','garusa','gatgaten','gumargar','gumitel','gura','gurit','gurot'],tagalog:['galamay','kamay','mabuti kung','kariton','kagatin','mag-ingay','nagutom','kinasusuklaman','guhit','likod'],english:['tentacles','hand','good thing','sleight','to chew','noisy','to feel hungry','hate','line','back'],form:['adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.'],prons:['ga-may','ga-met','gana-gana','ga-ru-sa','gat-gaten','gu-ra-sa','gu-mi-tel','gu-ra','gu-rit','gu-rot']};var word_I={bolinao:['ibaki','ibarita','ibati','iberber','ikadane','ikadani','ikapen','ilako','ilwa','imet','ipamuspusan','iparate','ipos','iregreg','isrep','isuble','isurot','itben','itgen','ituga','itulek','iyator'],tagalog:['utusan','sabihin','iwan','itali','ilapit','ilapit','paglaruan','ibenta','ilabas','itapon','gawin lahat ng paraan','iparating','ubusin','igilid','ipasok','ibalik','itusok','itapat','itigil','tobesearched','tobesearched','itago'],english:['command','tell','leave','to tie the rope','to bring closer','to bring near','to play with','to sell','bring out','to throw away','tobesearched','to inform','to use all','to bring at the edge','enter','to return','to inject','to place beside','to stop','tobesearched','tobesearched','hide'],form:['adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.',],prons:['iba-ki','ibari-ta','iba-ti','iber-ber','ika-da-ne','ikada-ni','ikap-en','ila-ko','il-wa','i-met','ipamus-pusan','ipara-te','i-pos','ireg-reg','is-rep','isub-le','isu-rot','it-ben','it-gen','itu-ga','itu-lek','iya-tor']};var word_K={bolinao:['kaaluyon','kabakas','kabaraybay','kadane','kalotsa','kanding','kanen','kanit','karate','katanda','kayat','kimat','kitanda','kudor','kumon'],tagalog:['kasama','kamukha','kapit-bahay','katabi','karibat','kambing','pagkain','langgam','kararating','kilala','kagat','kidlat','magpakilala','kulog','sana'],english:['companion','alike','neighbor','beside','competator','goat','food','ant','just arrived','acquintance','bite','lightning','to introduce','sound of lightning','if only'],form:['adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.',],prons:['kaa-lu-yon','ka-bakas','kabaray-bay','ka-da-ne','kalot-sa','kanding','ka-nen','kanit','ka-ra-te','ka-tan-da','ka-yat','ki-mat','ki-tan-da','ku-dor','ku-mon']};var word_L={bolinao:['laking','lako','lalako','laya','libot','lombot','lumwa'],tagalog:['lolo','tinda','maglakad','luya','sagala','magkasya','lumabas'],english:['grandpa','products','to walk','ginger','parade','tobesearched','tobesearched'],form:['adj.','adj.','adj.','adj.','adj.','adj.','adj.',],prons:['la-king','la-ko','la-la-ko','la-ya','li-bot','lom-bot','lum-wa']};var word_M={bolinao:['maado','maakes','maapre','mabanget','mabarang','mabare','mabereng','mabista','madaluyon','magana-gana','magsen','makan','makapakales','makit','maksaw','malangsi','malek','malumo','mamot','manabo','manager','manago','manaliw','masager','maserey','masrepan','matamlad','mataway','matib-ey','matpel','meket','mibakas','miikap','misna','misna','mula','muli'],tagalog:['mapagmahal','iyakin','mahapdi','mabaho','maligaw','mabali','malungkot','maganda','maalon','maganda','matibay','pagkain','nakakatawa','makita','malakas','malansa','matulog','malambot','mainit','mahulog','magalit','mag-igib','bibili','galit','matulis','mapasukan','tamad','masarap','matigas','malakas ang loob','magkita','magkamukha','maglaro','magkitakita','magsalubong','tanim','umakyat'],english:['lovable','cry','painful','odorous','tobesearched','torn','sad','beautiful','characterized big waves','beautiful','strong','food','funny','see','strong','smell fishy','to sleep','soft','hot','fell','anger','tobesearched','to buy','angry','sharp','tobesearched','lazy','delicious','hard','brave','meet up','look alike','play','meet','tobesearched','crop','climb up'],form:['adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.'],prons:['maa-do','maa-kes','maap-re','ma-bang-et','ma-ba-rang','ma-ba-re','ma-be-reng','ma-bis-ta','ma-da-lu-yon','magana-gana','mag-sen','ma-kan','ma-ka-pa-ka-les','ma-kit','mak-saw','ma-lang-si','ma-lek','ma-lu-mo','ma-mot','ma-na-bo','ma-na-ger','ma-na-go','ma-na-liw','ma-sa-ger','ma-se-rey','mas-re-pan','ma-tam-lad','ma-ta-way','matib-ey','mat-pel','me-ket','mi-ba-kas','mii-kap','mis-na','mis-na','mula','mu-li']};var word_N={bolinao:['nablo','nabok','nabotbot','nabsoy','nabsoy','naburas','nabyay','nadali','nakakan','nakalot','nakarate','nakayadi','nakiirgo','nako','nalek','nalingo','nalsok','naluang','namet','nanab-ang','nanabo','nanager','nanaras','nangadikleng','nangaduka','nangagas','nangalaki','nangamot','nangasin','nangray-ep','nangyadi','naninek','napiklo','napiknga','napsit','nariwak','nasabat','nasida','naspak','nasrep','nasurot','nataranaan','natra','natyanan','naulaw','nayadi','ngaran','nibati','nika','ninom','nipos','nisagad','niyator','nuli'],tagalog:['napilayan','lasing','nabutas','nabusog','nabusog','naalis','nabuhay','natira/natamaan','nakakain','nabingwit','nakarating','nakatapos','nakipag','pumunta','natutulog','nalito','nayupi','nabaliw','nawala','matabang','nahulog','galitnagalit','napakabilis','napakaliit','napakapangit','napakaanghang','napakalaki','napakainit','napakaasim','napakalamig','nangyari','napakatahimik','nayupi','nahati','napisa','nawasak','nadagit','nasira','nabasag','napasok','natusok','naumpisahan','natira','natuyo','nahilo','natapos','pangalan','iniwan','ipinunta','uminom','inubos','isinagad','tinago','umakyat'],english:['fractured','influenced in alcohol','makehole','fill','filled','removed','lived','attacked','eaten','captured','arrived','finished','talked','went','sleeping','commit lapses','disfigure','become crazy','lost','tasteless','fallen','very angry','full speed','very small','very ugly','very spicy','very big','very hot','very salty','very cold','happened','so silent','bended','divided','tobesearched','wrecked','captured by net','destroyed','broke','enterred','tobesearched','started','excess','dried','dizzy','ended','name','left','deliver','drink','exhaust','full blast','hide','climb'],form:['adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.','adj.'],prons:['nab-lo','na-bok','na-bot-bot','nab-soy','nab-soy','na-bu-ras','nab-soy','na-da-li','na-ka-kan','nakal-ot','na-ka-ra-te','na-ka-ya-di','na-kiir-go','na-ko','na-lek','na-li-ngo','nal-sok','na-lu-ang','na-met','nanab-ang','na-na-bo','na-na-ger','na-na-ras','nanga-dik-leng','nanga-duka','nanga-gas','nanga-laki','nanga-mot','nanga-sin','nang-ray-ep','nang-yadi','na-ni-nek','na-yu-pi','na-pik-nga','nap-sit','na-ri-wak','na-sa-bat','na-si-da','nas-pak','nas-rep','na-su-rot','na-ta-ra-naan','nat-ra','nat-ya-nan','na-u-law','na-ya-di','nga-ran','ni-ba-ti','ni-ka','ni-nom','ni-pos','ni-sa-gad','ni-ya-tor','nu-li']};var word_O={bolinao:['oha','olay','olebok','omi','ongot','opa'],tagalog:['dokumento','ahas','lasinggero','ihi','Buko','inahin'],english:['document','snake','drunkard','urine','Coconut','broiler'],form:['adj.','adj.','adj.','adj.','adj.','adj.'],prons:['o-ha','o-lay','o-le-bok','o-mi','o-ngot','o-pa']};var word_P={bolinao:['pada','pagal','pakayupa','pako','patagay','patanid'],tagalog:['magkatulad/magkapareho','pagod','pababa','pagpunta','pataas','magpaalam'],english:['similar/same','tired','going down','coming','going up','bid goodbye'],form:['adj.','adj.','adj.','adj.','adj.','adj.'],prons:['pa-da','pa-gal','pa-ka-yu-pa','pako','pa-ta-gay','pa-ta-nid']};var word_R={bolinao:['rayak','regreg','rikor','rumikor'],tagalog:['napakarami','gilid','labas','lumabas'],english:['plenty','side','outside','go outside'],form:['adj.','adj.','adj.','adj.'],prons:['ra-yak','reg-reg','ri-kor','ru-mi-kor']};
